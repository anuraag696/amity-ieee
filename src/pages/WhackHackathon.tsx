    ...
    <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-background via-card to-background relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-12">
              <span className="inline-flex items-center gap-2 text-sm font-semibold text-accent uppercase tracking-wider mb-4 animate-fade-in">
                <Sparkles size={16} className="animate-pulse" />
                Registration Open
                <Sparkles size={16} className="animate-pulse" />
              </span>
              <h2 className="font-heading text-3xl sm:text-4xl font-bold text-foreground animate-slide-up stagger-1">
                Scan & <span className="text-primary">Register Now</span>
              </h2>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative group animate-scale-in">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary via-accent to-primary rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500" />
                  <div className="relative bg-card rounded-3xl p-8 border border-border group-hover:border-primary/50 transition-all duration-500 hover-lift">
                    <div className="absolute -top-3 -right-3">
                      <div className="bg-accent text-accent-foreground px-4 py-1.5 rounded-full text-sm font-semibold flex items-center gap-2 animate-pulse-slow shadow-lg">
                        <QrCode size={16} />
                        Quick Register
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <div className="bg-white p-6 rounded-2xl shadow-inner">
                        <img 
                          src={whackQR} 
                          alt="Whack-Hackathon 4.0 Registration QR Code" 
                          className="w-full max-w-[250px] mx-auto aspect-square object-contain group-hover:scale-105 transition-transform duration-500"
                        />
                      </div>
                    </div>
                    
                    <p className="text-center text-muted-foreground mt-6 text-sm">
                      Point your camera at the QR code to register instantly
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6 animate-slide-in-right">
                  <div className="bg-card rounded-2xl p-6 border border-border hover:border-primary/30 transition-all duration-300 hover-lift">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Students from other universities can register for Whack-Hackathon 4.0! Scan the QR code or click the button below to participate.
                    </p>
                  </div>
                  ...
                  <a 
                    ...
                    className="block"
                  >
                    <Button variant="gold" size="lg" className="w-full hover:scale-[1.02] transition-transform hover-glow group">
