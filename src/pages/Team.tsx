    ...
    <div className="aspect-square bg-gradient-to-br from-primary/10 to-accent/10 relative overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center">
        {member.image ? (
          ...
          <div className="w-20 h-20 bg-primary/20 rounded-full flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {studentAdvisors.map((member, index) => (
